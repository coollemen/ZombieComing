...
namespace TDTK{
	...
	public class AttackInfo{
		...
		public bool UseEffect(){ return effect!=null; }
		...
		public AttackInfo(Unit sUnit, Unit tUnit, bool useAOE=true){
			...
			if(Random.value<srcUnit.GetEffectOnHitChance()) effect=srcUnit.GetEffectOnHit();
		...
		public AttackInfo(Ability ability, Unit tUnit, bool useAOE=true){
			...
			if(Random.value<ability.GetEffectOnHitChance()) effect=ability.GetEffectOnHit();
