        ...
        switch (s.loadLevel) {
            ...
            case MadLevelAbstractLayout.LoadLevel.SendMessage:
                using (MadGUI.Indent()) {
                    ...
                    MadGUI.PropertyField(loadLevelMessageName, "Method TypeID", MadGUI.StringNotEmpty);
    ...
    void ActivateAction(
        ...
        MadGUI.ConditionallyEnabled(message.boolValue, () => {
            MadGUI.Indent(() => {
                ...
                MadGUI.PropertyField(messageMethodName, "Method TypeID", MadGUI.StringNotEmpty);
